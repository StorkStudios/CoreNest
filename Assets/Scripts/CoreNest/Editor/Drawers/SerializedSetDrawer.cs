...
public class EnumSerializedSetDrawer : StatefulPropertyDrawer<EnumSerializedSetDrawer.State>
{
    ...
    private ReorderableList CreateList(SerializedProperty property)
    {
        ...
        ReorderableList list = new ReorderableList(listProperty.serializedObject, listProperty, true, false, true, true);
    ...
    private void OnAddDropdownCallback(Rect buttonRect, ReorderableList list)
    {
        ...
        foreach (SerializedProperty element in list.serializedProperty)
        {
            ...
            string valueName = itemProperty.enumNames[itemProperty.enumValueIndex];
    ...
    private void AddClickHandler(ReorderableList list, object value)
    {
        ...
        SerializedProperty element = list.serializedProperty.GetArrayElementAtIndex(index);
        SerializedProperty key = element.FindPropertyRelative("item");
